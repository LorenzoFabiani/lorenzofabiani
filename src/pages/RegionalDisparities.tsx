      ...
      <section style={{
        ...
        <div style={{maxWidth: '800px'}}> 
          ...
          <p style={{marginBottom: '20px', color: 'white'}}>
            <strong>Abstract:</strong> This study examines economic convergence among Italian regions from 1995 to 2022, focusing on beta and sigma convergence. Beta convergence assesses whether poorer regions grow faster than richer ones by analyzing the relationship between initial per capita GDP levels and subsequent growth rates. The results show no overall beta convergence for the entire period, as economic disparities widened. Notably, a trend toward convergence is observed from 1995 to 2008, followed by divergence from 2008 to 2022, primarily due to the economic crisis. Sigma convergence, which measures the reduction in regional disparities, aligns with these findings, showing a decrease in disparities before the crisis and an increase afterward. Significant regional variations are highlighted, with Basilicata experiencing growth due to a resurgence in automotive production, while regions like Umbria and Valle d'Aosta face stagnation due to structural issues. These results underscore the need for targeted policies to promote economic convergence and reduce regional disparities, considering the spatial distribution of economic activities and localized dynamic externalities. The analysis emphasizes the impact of the economic crisis on regional dynamics, exacerbating pre-existing differences and hindering convergence efforts.
          </p>
        </div>
      </section>
    </Page>
